...
(function (factory) {
  ...
  var Popover = function () {
     ...
     * @param {Boolean} isAirMode
     */
    this.update = function ($popover, styleInfo, isAirMode, isMouseEvent) {
      ...
      // } else if (isAirMode && isMouseEvent && ($airPopover.css("display") !== "block")) {
      //   // Added to deal with the situation where a user clicks on the editor.
      //   // Need to make sure that the range has a width so we can use getClientRects.
      //   var span = document.createElement("span");
      //   if (span.getClientRects) {
      //     span.appendChild(document.createTextNode("\u200b"));
      //     styleInfo.range.insertNode(span);
      //     rect = list.head(span.getClientRects());
      //     if (rect) {
      //       var bnd = func.rect2bnd(rect);
      //       showPopover($airPopover, {
      //         left: Math.max(bnd.left + bnd.width/2 - PX_POPOVER_ARROW_OFFSET_X, 0),
      ...
      //       });
      //     }
      //     var parentOfSpan = span.parentNode;
      //     parentOfSpan.removeChild(span);
      //     parentOfSpan.normalize();
      //   }
      } else {
        $airPopover.hide();
      }
  ...
  var EventHandler = function () {
    ...
    var hToolbarAndPopoverUpdate = function (event) {
      ...
      setTimeout(function () {
        ...
        modules.popover.update(layoutInfo.popover(), styleInfo, isAirMode, event.type === "mouseup");
