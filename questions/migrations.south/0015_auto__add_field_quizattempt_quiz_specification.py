...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuizAttempt.quiz_specification'
        db.add_column(u'questions_quizattempt', 'quiz_specification',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='attempts', null=True, to=orm['questions.QuizSpecification']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuizAttempt.quiz_specification'
        db.delete_column(u'questions_quizattempt', 'quiz_specification_id')
