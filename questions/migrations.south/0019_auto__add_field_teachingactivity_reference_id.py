...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeachingActivity.reference_id'
        db.add_column(u'questions_teachingactivity', 'reference_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TeachingActivity.reference_id'
        db.delete_column(u'questions_teachingactivity', 'reference_id')
