...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionAttempt.position'
        db.add_column(u'questions_questionattempt', 'position',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionAttempt.position'
        db.delete_column(u'questions_questionattempt', 'position')
