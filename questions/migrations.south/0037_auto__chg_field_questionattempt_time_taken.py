...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QuestionAttempt.time_taken'
        db.alter_column(u'questions_questionattempt', 'time_taken', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'QuestionAttempt.time_taken'
        db.alter_column(u'questions_questionattempt', 'time_taken', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))
