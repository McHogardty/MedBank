...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QuestionRating'
        db.create_table(u'questions_questionrating', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(related_name='question_ratings', to=orm['questions.Student'])),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ratings', to=orm['questions.Question'])),
            ('rating', self.gf('django.db.models.fields.IntegerField')()),
            ('date_rated', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'questions', ['QuestionRating'])

        # Adding model 'QuestionAttempt'
        db.create_table(u'questions_questionattempt', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(related_name='question_attempts', to=orm['questions.Student'])),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(related_name='attempts', to=orm['questions.Question'])),
            ...
            ('date_attempted', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('confidence_rating', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'questions', ['QuestionAttempt'])


    def backwards(self, orm):
        # Deleting model 'QuestionRating'
        db.delete_table(u'questions_questionrating')

        # Deleting model 'QuestionAttempt'
        db.delete_table(u'questions_questionattempt')
    ...
    models = {
        ...
        u'questions.questionattempt': {
            ...
            'answer': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'confidence_rating': ('django.db.models.fields.IntegerField', [], {}),
            'date_attempted': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'question': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'attempts'", 'to': u"orm['questions.Question']"}),
            'student': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'question_attempts'", 'to': u"orm['questions.Student']"}),
