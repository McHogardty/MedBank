...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'questions_quizattempt', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(related_name='quiz_attempts', to=orm['questions.Student'])),
            ('date_submitted', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'questions', ['QuizAttempt'])

        # Adding field 'QuestionAttempt.quiz_attempt'
        db.add_column(u'questions_questionattempt', 'quiz_attempt',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='questions', null=True, to=orm['questions.QuizAttempt']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'QuizAttempt'
        db.delete_table(u'questions_quizattempt')

        # Deleting field 'QuestionAttempt.quiz_attempt'
        db.delete_column(u'questions_questionattempt', 'quiz_attempt_id')
