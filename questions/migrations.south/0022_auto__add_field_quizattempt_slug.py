...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuizAttempt.slug'
        db.add_column(u'questions_quizattempt', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=36),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuizAttempt.slug'
        db.delete_column(u'questions_quizattempt', 'slug')
