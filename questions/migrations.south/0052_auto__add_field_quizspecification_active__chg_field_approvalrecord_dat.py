...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuizSpecification.active'
        db.add_column(u'questions_quizspecification', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'ApprovalRecord.date_assigned'
        db.alter_column(u'questions_approvalrecord', 'date_assigned', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        # Deleting field 'QuizSpecification.active'
        db.delete_column(u'questions_quizspecification', 'active')
