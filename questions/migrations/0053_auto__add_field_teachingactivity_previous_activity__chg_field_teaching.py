...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeachingActivity.previous_activity'
        db.add_column(u'questions_teachingactivity', 'previous_activity',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['questions.TeachingActivity'], unique=True, null=True, blank=True),
                      keep_default=False)


        # Changing field 'TeachingActivity.reference_id'
        db.alter_column(u'questions_teachingactivity', 'reference_id', self.gf('django.db.models.fields.IntegerField')(default=0, unique=True))

    def backwards(self, orm):
        # Deleting field 'TeachingActivity.previous_activity'
        db.delete_column(u'questions_teachingactivity', 'previous_activity_id')


        # Changing field 'TeachingActivity.reference_id'
        db.alter_column(u'questions_teachingactivity', 'reference_id', self.gf('django.db.models.fields.IntegerField')(unique=True, null=True))
