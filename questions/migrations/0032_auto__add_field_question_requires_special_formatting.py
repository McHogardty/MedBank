...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.requires_special_formatting'
        db.add_column(u'questions_question', 'requires_special_formatting',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.requires_special_formatting'
        db.delete_column(u'questions_question', 'requires_special_formatting')
