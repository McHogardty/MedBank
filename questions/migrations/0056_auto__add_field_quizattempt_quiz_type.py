...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuizAttempt.quiz_type'
        db.add_column(u'questions_quizattempt', 'quiz_type',
                      self.gf('django.db.models.fields.CharField')(default='individual', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuizAttempt.quiz_type'
        db.delete_column(u'questions_quizattempt', 'quiz_type')
