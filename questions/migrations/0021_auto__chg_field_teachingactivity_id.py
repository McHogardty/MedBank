...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TeachingActivity.id'
        db.alter_column(u'questions_teachingactivity', u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

    def backwards(self, orm):

        # Changing field 'TeachingActivity.id'
        db.alter_column(u'questions_teachingactivity', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))
