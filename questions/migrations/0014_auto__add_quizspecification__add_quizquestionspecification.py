...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QuizSpecification'
        db.create_table(u'questions_quizspecification', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('stage', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['questions.Stage'], null=True, blank=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=36)),
        ))
        db.send_create_signal(u'questions', ['QuizSpecification'])

        # Adding model 'QuizQuestionSpecification'
        db.create_table(u'questions_quizquestionspecification', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('specification_type', self.gf('django.db.models.fields.IntegerField')()),
            ('quiz_specification', self.gf('django.db.models.fields.related.ForeignKey')(related_name='questions', to=orm['questions.QuizSpecification'])),
            ('parameters', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'questions', ['QuizQuestionSpecification'])


    def backwards(self, orm):
        # Deleting model 'QuizSpecification'
        db.delete_table(u'questions_quizspecification')

        # Deleting model 'QuizQuestionSpecification'
        db.delete_table(u'questions_quizquestionspecification')
