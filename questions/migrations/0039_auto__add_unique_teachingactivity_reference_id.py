...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'TeachingActivity', fields ['reference_id']
        db.create_unique(u'questions_teachingactivity', ['reference_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'TeachingActivity', fields ['reference_id']
        db.delete_unique(u'questions_teachingactivity', ['reference_id'])
