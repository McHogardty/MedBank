...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Question.date_assigned'
        db.alter_column(u'questions_question', 'date_assigned', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Question.date_assigned'
        db.alter_column(u'questions_question', 'date_assigned', self.gf('django.db.models.fields.DateTimeField')())
