...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TeachingBlockYear.year'
        db.alter_column(u'questions_teachingblockyear', 'year', self.gf('django.db.models.fields.IntegerField')(default=0))

    def backwards(self, orm):

        # Changing field 'TeachingBlockYear.year'
        db.alter_column(u'questions_teachingblockyear', 'year', self.gf('django.db.models.fields.IntegerField')(null=True))
