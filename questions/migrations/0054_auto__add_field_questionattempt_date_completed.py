...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionAttempt.date_completed'
        db.add_column(u'questions_questionattempt', 'date_completed',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionAttempt.date_completed'
        db.delete_column(u'questions_questionattempt', 'date_completed')
