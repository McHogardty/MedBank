...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_second_table_name = db.shorten_name(u'questions_teachingactivity_block_year')
        db.rename_table(m2m_first_table_name, m2m_second_table_name)

    def backwards(self, orm):
        # Renaming M2M table for field block_year on 'TeachingActivity'
        m2m_first_table_name = db.shorten_name(u'questions_teachingactivity_block_year')
