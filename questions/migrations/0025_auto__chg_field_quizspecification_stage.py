...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QuizSpecification.stage'
        db.alter_column(u'questions_quizspecification', 'stage_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['questions.Stage']))

    def backwards(self, orm):

        # Changing field 'QuizSpecification.stage'
        db.alter_column(u'questions_quizspecification', 'stage_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['questions.Stage'], null=True))
