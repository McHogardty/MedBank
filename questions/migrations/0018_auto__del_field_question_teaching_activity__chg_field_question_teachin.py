...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Question.teaching_activity'
        db.delete_column(u'questions_question', 'teaching_activity_id')


        # Changing field 'Question.teaching_activity_year'
        db.alter_column(u'questions_question', 'teaching_activity_year_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['questions.TeachingActivityYear']))
        # Deleting field 'TeachingActivity.week'
        db.delete_column(u'questions_teachingactivity', 'week')

        # Deleting field 'TeachingActivity.position'
        db.delete_column(u'questions_teachingactivity', 'position')

        # Removing M2M table for field block_year on 'TeachingActivity'
        db.delete_table(db.shorten_name(u'questions_teachingactivity_block_year'))
    ...
    def backwards(self, orm):
        # Adding field 'Question.teaching_activity'
        db.add_column(u'questions_question', 'teaching_activity',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=5767, related_name='questions', to=orm['questions.TeachingActivity']),
                      keep_default=False)


        # Changing field 'Question.teaching_activity_year'
        db.alter_column(u'questions_question', 'teaching_activity_year_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['questions.TeachingActivityYear']))
        # Adding field 'TeachingActivity.week'
        db.add_column(u'questions_teachingactivity', 'week',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'TeachingActivity.position'
        db.add_column(u'questions_teachingactivity', 'position',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding M2M table for field block_year on 'TeachingActivity'
        m2m_table_name = db.shorten_name(u'questions_teachingactivity_block_year')
