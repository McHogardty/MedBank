...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'QuestionAttempt.student'
        db.delete_column(u'questions_questionattempt', 'student_id')

        # Deleting field 'QuestionAttempt.date_attempted'
        db.delete_column(u'questions_questionattempt', 'date_attempted')


        # Changing field 'QuestionAttempt.quiz_attempt'
        db.alter_column(u'questions_questionattempt', 'quiz_attempt_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['questions.QuizAttempt']))

    def backwards(self, orm):
        # Adding field 'QuestionAttempt.student'
        student = orm.Student.objects.all()[0]
        db.add_column(u'questions_questionattempt', 'student',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=student.pk, related_name='question_attempts', to=orm['questions.Student']),
                      keep_default=False)

        # Adding field 'QuestionAttempt.date_attempted'
        db.add_column(u'questions_questionattempt', 'date_attempted',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 1, 22, 0, 0), blank=True),
                      keep_default=False)


        # Changing field 'QuestionAttempt.quiz_attempt'
        db.alter_column(u'questions_questionattempt', 'quiz_attempt_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['questions.QuizAttempt']))
