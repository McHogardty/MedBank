...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TeachingBlock.code'
        db.alter_column(u'questions_teachingblock', 'code', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'TeachingBlock.code'
        db.alter_column(u'questions_teachingblock', 'code', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
