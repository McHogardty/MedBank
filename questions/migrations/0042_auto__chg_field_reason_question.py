...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reason.question'
        db.alter_column(u'questions_reason', 'question_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['questions.Question']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Reason.question'
        raise RuntimeError("Cannot reverse this migration. 'Reason.question' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Reason.question'
        db.alter_column(u'questions_reason', 'question_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['questions.Question']))
    ...
    models = {
        ...
        u'questions.reason': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'question': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'reasons_edited'", 'null': 'True', 'to': u"orm['questions.Question']"}),
