...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TeachingActivityYear'
        db.create_table(u'questions_teachingactivityyear', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('teaching_activity', self.gf('django.db.models.fields.related.ForeignKey')(related_name='years', to=orm['questions.TeachingActivity'])),
            ('week', self.gf('django.db.models.fields.IntegerField')()),
            ('position', self.gf('django.db.models.fields.IntegerField')()),
            ('block_year', self.gf('django.db.models.fields.related.ForeignKey')(related_name='year_activities', to=orm['questions.TeachingBlockYear'])),
        ))
        db.send_create_signal(u'questions', ['TeachingActivityYear'])

        # Adding M2M table for field question_writers on 'TeachingActivityYear'
        m2m_table_name = db.shorten_name(u'questions_teachingactivityyear_question_writers')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('teachingactivityyear', models.ForeignKey(orm[u'questions.teachingactivityyear'], null=False)),
            ('student', models.ForeignKey(orm[u'questions.student'], null=False))
        ))
        db.create_unique(m2m_table_name, ['teachingactivityyear_id', 'student_id'])

        # Adding field 'Question.teaching_activity_year'
        db.add_column(u'questions_question', 'teaching_activity_year',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='year_questions', null=True, to=orm['questions.TeachingActivityYear']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TeachingActivityYear'
        db.delete_table(u'questions_teachingactivityyear')

        # Removing M2M table for field question_writers on 'TeachingActivityYear'
        db.delete_table(db.shorten_name(u'questions_teachingactivityyear_question_writers'))

        # Deleting field 'Question.teaching_activity_year'
        db.delete_column(u'questions_question', 'teaching_activity_year_id')
