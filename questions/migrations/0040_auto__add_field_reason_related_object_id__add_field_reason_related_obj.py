...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reason.related_object_id'
        db.add_column(u'questions_reason', 'related_object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Reason.related_object_content_type'
        db.add_column(u'questions_reason', 'related_object_content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reason.related_object_id'
        db.delete_column(u'questions_reason', 'related_object_id')

        # Deleting field 'Reason.related_object_content_type'
        db.delete_column(u'questions_reason', 'related_object_content_type_id')
