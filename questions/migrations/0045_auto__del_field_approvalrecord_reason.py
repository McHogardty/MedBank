...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ApprovalRecord.reason'
        db.delete_column(u'questions_approvalrecord', 'reason')


    def backwards(self, orm):
        # Adding field 'ApprovalRecord.reason'
        db.add_column(u'questions_approvalrecord', 'reason',
