...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuizSpecification.description'
        db.add_column(u'questions_quizspecification', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuizSpecification.description'
        db.delete_column(u'questions_quizspecification', 'description')
