...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Reason.question'
        db.delete_column(u'questions_reason', 'question_id')
    ...
    def backwards(self, orm):
        ...
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Reason.question'
        db.add_column(u'questions_reason', 'question',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='reasons_edited', to=orm['questions.Question']),
                      keep_default=False)
