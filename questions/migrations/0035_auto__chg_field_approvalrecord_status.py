...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ApprovalRecord.status'
        db.alter_column(u'questions_approvalrecord', 'status', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ApprovalRecord.status'
        db.alter_column(u'questions_approvalrecord', 'status', self.gf('django.db.models.fields.IntegerField')())
