...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TeachingBlock.number'
        db.delete_column(u'questions_teachingblock', 'number')


    def backwards(self, orm):
        # Adding field 'TeachingBlock.number'
        db.add_column(u'questions_teachingblock', 'number',
