...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeachingBlock.code'
        db.add_column(u'questions_teachingblock', 'code',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TeachingBlock.code'
        db.delete_column(u'questions_teachingblock', 'code')
