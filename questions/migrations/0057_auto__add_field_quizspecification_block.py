...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuizSpecification.block'
        db.add_column(u'questions_quizspecification', 'block',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['questions.TeachingBlock'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuizSpecification.block'
        db.delete_column(u'questions_quizspecification', 'block_id')
    ...
    models = {
        ...
        u'questions.quizattempt': {
            ...
            'quiz_type': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
        ...
        u'questions.quizspecification': {
            ...
            'block': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['questions.TeachingBlock']", 'null': 'True', 'blank': 'True'}),
        ...
        u'questions.stage': {
            'Meta': {'ordering': "('number',)", 'object_name': 'Stage'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
