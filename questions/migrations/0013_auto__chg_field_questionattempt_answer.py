...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QuestionAttempt.answer'
        db.alter_column(u'questions_questionattempt', 'answer', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))

    def backwards(self, orm):

        # Changing field 'QuestionAttempt.answer'
        db.alter_column(u'questions_questionattempt', 'answer', self.gf('django.db.models.fields.CharField')(default='A', max_length=1))
