...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reason.reason_type'
        db.add_column(u'questions_reason', 'reason_type',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reason.reason_type'
        db.delete_column(u'questions_reason', 'reason_type')
