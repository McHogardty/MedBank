...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.date_assigned'
        db.add_column(u'questions_question', 'date_assigned',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Question.date_completed'
        db.add_column(u'questions_question', 'date_completed',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.date_assigned'
        db.delete_column(u'questions_question', 'date_assigned')

        # Deleting field 'Question.date_completed'
        db.delete_column(u'questions_question', 'date_completed')
