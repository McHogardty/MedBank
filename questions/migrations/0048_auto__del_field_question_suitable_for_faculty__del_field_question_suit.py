...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Question.suitable_for_faculty'
        db.delete_column(u'questions_question', 'suitable_for_faculty')

        # Deleting field 'Question.suitable_for_quiz'
        db.delete_column(u'questions_question', 'suitable_for_quiz')


        # Changing field 'ApprovalRecord.date_assigned'
        db.alter_column(u'questions_approvalrecord', 'date_assigned', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Adding field 'Question.suitable_for_faculty'
        db.add_column(u'questions_question', 'suitable_for_faculty',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Question.suitable_for_quiz'
        db.add_column(u'questions_question', 'suitable_for_quiz',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'ApprovalRecord.date_assigned'
        db.alter_column(u'questions_approvalrecord', 'date_assigned', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
