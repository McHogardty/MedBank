...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TeachingBlockYear.end'
        db.alter_column(u'questions_teachingblockyear', 'end', self.gf('django.db.models.fields.DateField')())

        # Changing field 'TeachingBlockYear.start'
        db.alter_column(u'questions_teachingblockyear', 'start', self.gf('django.db.models.fields.DateField')())

        # Changing field 'TeachingBlockYear.sign_up_mode'
        db.alter_column(u'questions_teachingblockyear', 'sign_up_mode', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'TeachingBlockYear.weeks'
        db.alter_column(u'questions_teachingblockyear', 'weeks', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'TeachingBlockYear.block'
        db.alter_column(u'questions_teachingblockyear', 'block_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['questions.TeachingBlock']))

        # Changing field 'TeachingBlockYear.activity_capacity'
        db.alter_column(u'questions_teachingblockyear', 'activity_capacity', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'TeachingBlockYear.end'
        db.alter_column(u'questions_teachingblockyear', 'end', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'TeachingBlockYear.start'
        db.alter_column(u'questions_teachingblockyear', 'start', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'TeachingBlockYear.sign_up_mode'
        db.alter_column(u'questions_teachingblockyear', 'sign_up_mode', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'TeachingBlockYear.weeks'
        db.alter_column(u'questions_teachingblockyear', 'weeks', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'TeachingBlockYear.block'
        db.alter_column(u'questions_teachingblockyear', 'block_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['questions.TeachingBlock'], null=True))

        # Changing field 'TeachingBlockYear.activity_capacity'
        db.alter_column(u'questions_teachingblockyear', 'activity_capacity', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        u'questions.teachingblockyear': {
            ...
            'block': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['questions.TeachingBlock']"}),
