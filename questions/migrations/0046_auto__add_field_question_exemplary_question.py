...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.exemplary_question'
        db.add_column(u'questions_question', 'exemplary_question',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.exemplary_question'
        db.delete_column(u'questions_question', 'exemplary_question')
